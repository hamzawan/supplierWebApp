...
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
  ...
  class customerMRN extends Component{
    constructor(props){
      super(props);
      this.state={
        sno:1, rows:[["019"]]
    ...
    render(){
      ...
      <div className="contain">
        ...
        <Button id="newBtn" type="submit" href="/newcustomerMRN">Add New</Button>
          ...
          <Table responsive>
            ...
            }
            {
              ...
              <tr key={i}>
                ...
                <td><a href="/editcustomerMRN"><FontAwesomeIcon icon="pencil-alt" /></a> &nbsp;&nbsp;
