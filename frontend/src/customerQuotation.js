...
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
  ...
  class customerQuotation extends Component{
    constructor(props){
      super(props);
      this.state={
        sno:1, rows:[["Ahmed","1","2-3 weeks","10 days","advance","Ex Works Karachi","aws11","Anas","free delivery"]]
      };
    }
    ...
    render(){
      ...
      <div className="contain">
        <h4 style={{paddingLeft:"40%"}}>Customer Quotation</h4>
        <Button id="newBtn" type="submit" href="/newcustomerQuotation">Add New</Button>
          ...
          <Table responsive>
            ...
            }
            {
              ...
              <tr key={i}>
                ...
                <td><a href="/editcustomerQuotation"><FontAwesomeIcon icon="pencil-alt" /></a> &nbsp;&nbsp;
