...
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
  ...
  class customerDeliveryChallan extends Component{
    constructor(props){
      super(props);
      this.state={
        sno:1, rows:[["001","019"]]
    ...
    render(){
      ...
      <div className="contain">
        ...
        <Button id="newBtn" type="submit" href="/newcustomerDeliveryChallan">Add New</Button>
          ...
          <Table responsive>
            ...
            }
            {
              ...
              <tr key={i}>
                ...
                <td><a href="/editcustomerDeliveryChallan"><FontAwesomeIcon icon="pencil-alt" /></a> &nbsp;&nbsp;
